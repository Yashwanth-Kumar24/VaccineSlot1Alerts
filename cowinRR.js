       ...
       // console.log(res.sessions)
            ...
            res.forEach((data)=>{
                ...
                if(data.available_capacity_dose1>0){
                    ...
                    av+=data.available_capacity_dose1
...
function sendMessage(place,dose1,centrenames,vaccinename1){
    var tempParams={
      location:place,
      to_name:"People",
      dose1:dose1,
      message:"Slots are opened, Book ASAP",
      vaccine1:vaccinename1,
      centername:centrenames,
    }
  
    emailjs.send('service_jlp34vk','template_p3loiss',tempParams)
    .then(function(res){
